...
class NaiveKMeans
{
 public:
   ...
   */
  NaiveKMeans(const MatType& dataset, MetricType& metric, const arma::Col<double>& weights, const bool include_weights);
 ...
 private:
  ...
  //! The data weights (if using)
  const arma::Col<double>& weights;
