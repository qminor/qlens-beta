        ...
        const bool initialGuess)
{
  ...
  weights.ones();
  Cluster(data, clusters, assignments, centroids, weights, false, initialGuess);
}
        ...
        const bool initialGuess)
{
  arma::Col<double> weights(data.n_cols);
  weights.ones();
  Cluster(data, clusters, centroids, weights, false, initialGuess);
}
        ...
        const bool initialCentroidGuess)
{
  ...
  Cluster(data, clusters, centroids, weights, include_weights,
