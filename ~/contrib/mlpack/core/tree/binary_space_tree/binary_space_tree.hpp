...
class BinarySpaceTree
{
 ...
 private:
  ...
  //! delete it.
  MatType* dataset;
  //! The weights associated with the data, if using
 ...
 public:
   ...
   */
  BinarySpaceTree(const MatType& data, const size_t maxLeafSize = 20, arma::Col<double>* weightvec = NULL);
  ...
  BinarySpaceTree(const MatType& data,
                  ...
                  const size_t maxLeafSize = 20, arma::Col<double>* weightvec = NULL);
  ...
  */
  ...
  //! indicate whether weights have been defined for the data points.
  const bool HasWeights() const { return (weights != NULL); }
  //! Get the weights attached to the points in the dataset.
  arma::Col<double>& Weights() { return *weights; }
