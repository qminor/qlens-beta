...
# NOTE: add $(STAN_INC) to CC line below to include stan; also add flag -DUSE_STAN below
STAN_DIR :=    # fill in stan directory here
STAN_INC = -I$(STAN_DIR) -I$(STAN_DIR)/lib/eigen_3.4.0 -I$(STAN_DIR)/lib/boost_1.87.0 -I$(STAN_DIR)/lib/sundials_6.1.1/include -I$(STAN_DIR)/lib/sundials_6.1.1/src/sundials -include $(STAN_DIR)/stan/prim/constraint/identity_free.hpp -I$(STAN_DIR)/lib/tbb_2020.3/include -I$(STAN_DIR)/lib/eigen_3.4.0
