                                         ...
                                         const size_t iteration)
{
  ...
  newCentroids.col(maxVarCluster) *= (clusterCounts[maxVarCluster] /
  ...
  clusterCounts[maxVarCluster] -= 1.0;
  clusterCounts[emptyCluster] += 1.0;
  ...
  // this->iteration.
  if (clusterCounts[maxVarCluster] <= 1.0)
  {
...
void MaxVarianceNewCluster::serialize(Archive& ,
                                      const uint32_t )
{
