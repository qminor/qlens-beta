...
class DelaunayGrid
{
	...
	void generate_gmatrices();
	void generate_hmatrices();
	void generate_covariance_matrix(double *cov_matrix_packed, const double corr_length, const int kernel_type, const double matern_index = -1, const bool lum_weighting = false, double *corrlength_pixel_weights = NULL);
