...
Alpha = SPLE({"b": 1.36, "alpha": 1.17, "s": 0.0, "e1": 0.01, "e2": 0.0, "xc": 0.01, "yc": 0.006},qlens=q)
...
extshear = Shear({"shear1": 0.05, "shear2": -0.05},qlens=q)
...
q.regularization_method="sgradient"
