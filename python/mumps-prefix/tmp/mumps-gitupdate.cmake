...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v5.4.0.0"
  WORKING_DIRECTORY "/Users/qminor/git_testdir/qlens-dev/qlens-beta/contrib/mumps"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v5.4.0.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v5.4.0.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/qminor/git_testdir/qlens-dev/qlens-beta/contrib/mumps'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/qminor/git_testdir/qlens-dev/qlens-beta/contrib/mumps'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
