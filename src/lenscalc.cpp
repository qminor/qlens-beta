...
template<typename QScalar>
void QLens::lens_equation(const lensvector<QScalar>& x, const lensvector<QScalar>& srcpt, lensvector<QScalar>& f, const int& thread, double *zfacs, double** betafacs)
{
...
template void QLens::lens_equation<double>(const lensvector<double>& x, const lensvector<double>& srcpt, lensvector<double>& f, const int& thread, double *zfacs, double** betafacs);
#ifdef USE_STAN
template void QLens::lens_equation<stan::math::var>(const lensvector<stan::math::var>& x, const lensvector<stan::math::var>& srcpt, lensvector<stan::math::var>& f, const int& thread, double* zfacs, double** betafacs);
#endif
